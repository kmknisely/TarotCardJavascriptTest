...
const card2 = document.getElementById("two");
const card3 = document.getElementById("three");
const card4 = document.getElementById("four");
...
function selectCard(){
  ...
  card1.addEventListener("click",function(){
    if(round===1){
      for (let i = 0; i < numberCard[0].number * 2; i++){
        setTimeout(toggle, i*seconds);
      };
    } else {
        answerTime = faceCard[0].name.length
        for (let i = 0; i < faceCard[0].name.length * 2; i++){
          setTimeout(toggle, i*seconds);
        };
    }
  });
  ...
  card2.addEventListener("click",function(){
    if(round===1){
      for (let i = 0; i < numberCard[1].number * 2; i++){
        setTimeout(toggle, i*seconds);
      };
    } else {
        answerTime = faceCard[1].name.length
        for (let i = 0; i < faceCard[1].name.length * 2; i++){
          setTimeout(toggle, i*seconds);
        };
    }
  });
  ...
  card3.addEventListener("click",function(){
    if(round===1){
      for (let i = 0; i < numberCard[2].number * 2; i++){
        setTimeout(toggle, i*seconds);
      };
    } else {
        answerTime = faceCard[2].name.length
        for (let i = 0; i < faceCard[2].name.length * 2; i++){
          setTimeout(toggle, i*seconds);
        };    }
  });
  ...
  card4.addEventListener("click",function(){
    if(round===1){
      for (let i = 0; i < numberCard[3].number * 2; i++){
        setTimeout(toggle, i*seconds);
    };
  } else {
      answerTime = faceCard[3].name.length
      for (let i = 0; i < faceCard[3].name.length * 2; i++){
        setTimeout(toggle, i*seconds);
      };    }
  });
